...
class State_consolidate extends State
{
    ...
    async tick() {
        ...
        this.executeBulk().then( ta => {
            ...
            //let hrv1h = this.isHighRelativeVolume(ta.candles_1h, 20);
            ...
            if(hrv4h) {
                ...
                if( ta.stochrsi_1h.valueFastK > ta.stochrsi_1h.valueFastD && 
                    ...
                    ta.stochrsi_1d.valueFastK > ta.stochrsi_1d.valueFastD ) {
                        ...
                        this.notifications.postSlackMessage(`Changing state to long bias...`);
                ...
                // And visa versa
                    ...
                    ta.stochrsi_1d.valueFastK < ta.stochrsi_1d.valueFastD ) {
                        ...
                        this.notifications.postSlackMessage(`Changing state to short bias...`);
